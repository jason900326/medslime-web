    ...
    <main className="min-h-screen bg-[#f8fcf9] text-[#17372a]">
      <div className="mx-auto max-w-4xl px-4 py-6 sm:px-5 md:px-8 md:py-10">
        ...
        <PolicySection title="付費學習服務、付款與交易異常">
          <p>
            MedSlime 的付費內容為線上學習服務，包括固定 30 天使用期間的 MedSlime Pro 學習方案，以及指定國考考卷的完整數位詳解。實際服務內容與價格以購買當下商城或題庫頁面顯示為準。付款由合作金流服務處理，付款完成後由 MedSlime 驗證交易結果並開通對應服務期間或指定數位內容。
          </p>
          <p className="mt-3">
            MedSlime 不提供以現金購買金幣、抽卡券、AI 次數、點數、錢包餘額或其他可儲值資產。站內金幣僅能透過學習、任務、專注與成就取得，且無法兌現、交易或轉讓。免費完整詳解的每日使用次數為服務使用上限，每日重新計算、未使用次數不累積，也不提供額外次數購買。
          </p>
          <p className="mt-3">
